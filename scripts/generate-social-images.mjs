...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="600" y="380" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="26" fill="#5c4f47">Learning the lore, one song at a time</text>
  <text x="600" y="470" text-anchor="middle" font-family="Georgia, serif" font-size="22" fill="#8a7a70">boyfriendguidetotaylorswift.com</text>
</svg>`;
